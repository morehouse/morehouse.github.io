...
coauthors: ["Yong Yu"]
featured_image: lnd_deadline_aware_budget_sweeper_header.png
---
...
And unfortunately proper on-chain resolution can be tricky to get right (see [1](/lightning/ldk-invalid-claims-liquidity-griefing/), [2](/lightning/ldk-duplicate-htlc-force-close-griefing/), [3](/lightning/lnd-excessive-failback-exploit/)).
